...
public class ActRuDeadletterJob implements Serializable {
    ...
    private static final long serialVersionUID = 1831039155;
    ...
    public ActRuDeadletterJob(ActRuDeadletterJob value) {
        this.id_ = value.id_;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("ActRuDeadletterJob (");
