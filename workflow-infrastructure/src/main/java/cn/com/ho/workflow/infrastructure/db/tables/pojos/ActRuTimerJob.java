...
public class ActRuTimerJob implements Serializable {
    ...
    private static final long serialVersionUID = -834372587;

    private String        id_;
    private Integer       rev_;
    private String        type_;
    private LocalDateTime lockExpTime_;
    ...
    public ActRuTimerJob(ActRuTimerJob value) {
        this.id_ = value.id_;
    ...
    public void setLockExpTime_(LocalDateTime lockExpTime_) {
        this.lockExpTime_ = lockExpTime_;
    }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("ActRuTimerJob (");
